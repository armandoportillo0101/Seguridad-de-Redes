...
## Solución
```
porti_04@DESKTOP-8HT902T:~/pico_retos/crypto$ cd readmycert
porti_04@DESKTOP-8HT902T:~/pico_retos/crypto/readmycert$ wget https://artifacts.picoctf.net/c/422/readmycert.csr
porti_04@DESKTOP-8HT902T:~/pico_retos/crypto/readmycert$ cat readmycert.csr
...
porti_04@DESKTOP-8HT902T:~/pico_retos/crypto/readmycert$ openssl req -in readmycert.csr -text
Certificate Request:
    Data:
        Version: 1 (0x0)
...
## Notas Adicionales
El comando ssl que usamos los sacamos de internet
