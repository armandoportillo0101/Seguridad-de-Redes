...
## Solución
```bash
Ingresamos al link y despues inspeccionamos la pagina, al inspeccionar nos saldrá lo siguiente: 
|   |
|---|
|<html>|
||<head>|
...
Despues ingrese a js beautifier para hacerlo mas facil de entender:
    <
    script type = "text/javascript" >
...
como podemos ver en el codigo se nos da la bandera, solo hay que decifrarla
bandera: picoCTF{not_this_again_50a029}
```
