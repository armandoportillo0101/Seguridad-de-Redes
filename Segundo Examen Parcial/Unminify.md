...
Browse [here](http://titan.picoctf.net:49288/), and find the flag!
```
[](https://github.com/armandoportillo0101/Seguridad-de-Redes/blob/main/Plantilla.md#objetivo)
## Solución
```
Para resolver este reto tienes que, despues de haber dado click en el boton launcher que te da link de la pagina donde esta la bandera y ya estés situado en esa pagina presionar click derecho y en ingresar al opción de inspeccioner. Una vez hecho lo anterior te vas hasta la pestañita de fuentes y te vas al archivo de índice, te mostrará un codigo y ahí se encontrará la bandera.

Este fue el codigo en mi caso: 
<!doctype html>
<html lang="en">
    <head>
        <meta charset="utf-8">
